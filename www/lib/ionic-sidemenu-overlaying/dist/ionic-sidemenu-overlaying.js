...
(function(name, definition) {
  ...
  else try { this[name] = definition(); } catch(e) {console.log(e); }
}('ionic-sidemenu-overlaying', function() {

  var moduleName = 'ionic-sidemenu-overlaying';
                ...
                var content = {
                  ...
                  addMenuHide: function () {
                    ...
                    if (menuContentHide == undefined) {
                      ...
                      menuContentHide.setAttribute('style', 'background: black; z-index: 10; position: absolute; width: 100%; height: 100%; opacity: 0.40; top: 0; visibility: hidden;');
